"""
Agent for technical indicator analysis.
Uses LLM and toolkit to compute and interpret MACD, RSI, ROC, Stochastic, and Williams %R.
"""
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    f"The OHLC data provided is from {time_frame} intervals, reflecting recent market behavior. "
