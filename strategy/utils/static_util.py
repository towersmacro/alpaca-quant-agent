...
def generate_kline_image(kline_data) -> dict:
    """Generate a candlestick chart and return base64-encoded image."""
    ...
    try:
        ...
        print("ValueError at static_util.py\n")
...
def generate_trend_image(kline_data) -> dict:
    """Generate a candlestick chart with trendlines and return base64-encoded image."""
